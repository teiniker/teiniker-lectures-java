...
**Server applications** should exhibit both good throughput and good responsiveness under 
...
To address the issue of **execution service lifecycle**, the **ExecutorService** interface extends 
